...
![DocuMind landing page: grounded answer with citations and live evaluation scores](docs/screenshots/01_landing.jpg)

## Screens

![Demo: ask a question, get a grounded answer with source citations and four evaluation scores](docs/screenshots/02_demo.jpg)

The demo page mirrors the Streamlit dashboard: ask a question, the answer is generated by Groq Llama 3.3 70B grounded in retrieved chunks, source chunks are shown with similarity scores, and every answer is scored on faithfulness, answer relevance, context precision, and hallucination rate.
